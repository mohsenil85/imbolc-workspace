...
impl SourceType {
    ...
    pub fn all() -> Vec<SourceType> {
        vec![
            ...
            SourceType::Vibes,
            SourceType::Kalimba,
            SourceType::SteelDrum,
            SourceType::TubularBell,
            SourceType::Glockenspiel,
            // Plucked Strings
            SourceType::Guitar,
            SourceType::BassGuitar,
            SourceType::Harp,
            SourceType::Koto,
            // Drums
            SourceType::Kick,
            SourceType::Snare,
            SourceType::HihatClosed,
            SourceType::HihatOpen,
            SourceType::Clap,
            SourceType::Cowbell,
            SourceType::Rim,
            SourceType::Tom,
    ...
    pub fn default_params(&self) -> Vec<Param> {
        match self {
            ...
            SourceType::Gendy => vec![
                ...
                Param {
                    name: "ampdist".to_string(),
                    value: ParamValue::Int(1),
                    min: 0.0,
                    max: 6.0,
                },
                Param {
                    name: "durdist".to_string(),
                    value: ParamValue::Int(1),
                    min: 0.0,
                    max: 6.0,
                },
                Param {
                    name: "minfreq".to_string(),
                    value: ParamValue::Float(100.0),
                    min: 20.0,
                    max: 1000.0,
                },
                Param {
                    name: "maxfreq".to_string(),
            ...
            SourceType::Chaos => vec![
                ...
                Param {
                    name: "chaos_freq".to_string(),
                    value: ParamValue::Float(8000.0),
                    min: 20.0,
                    max: 20000.0,
                },
                Param {
                    name: "chaos_param".to_string(),
            ...
            SourceType::Bowed => vec![
                ...
                Param {
                    name: "bow_pos".to_string(),
                    value: ParamValue::Float(0.12),
                    min: 0.01,
                    max: 0.5,
                },
            ],
    ...
    pub fn default_envelope(&self) -> EnvConfig {
        match self {
            ...
            | SourceType::Kalimba
            | SourceType::SteelDrum
            | SourceType::Glockenspiel => EnvConfig {
                attack: 0.001,
                decay: 1.5,
                sustain: 0.0,
                release: 0.2,
            ...
            SourceType::FMBell | SourceType::TubularBell => EnvConfig {
                attack: 0.001,
                decay: 2.0,
                sustain: 0.0,
                release: 0.5,
            ...
            SourceType::EPiano | SourceType::BrassStab | SourceType::FMBrass => EnvConfig {
                attack: 0.01,
                decay: 0.3,
                sustain: 0.5,
                release: 0.2,
            ...
            SourceType::Custom(_) | SourceType::Vst(_) => EnvConfig {
                attack: 0.01,
                decay: 0.1,
                sustain: 0.7,
                release: 0.3,
...
mod tests {
    ...
    fn source_type_custom_id() {
        assert_eq!(
            SourceType::Custom(CustomSynthDefId::new(5)).custom_id(),
            Some(CustomSynthDefId::new(5))
        );
    ...
    fn source_type_vst_id() {
        assert_eq!(
            SourceType::Vst(VstPluginId::new(3)).vst_id(),
            Some(VstPluginId::new(3))
        );
